                            ...
                            for b_ix in range(BATCH_COPIES):
                                ...
                                if b_ix == 0 and j == 0 and temp == temperatures[0]:
                                    ...
                                    try:
                                        ...
                                        commit_str = "unknown"
                                    f.write(
                                        ">{}, score={}, fixed_chains={}, designed_chains={}, model_name={}, git_hash={}\n{}\n".format(
                                            name_,
                                            native_score_print,
                                            print_visible_chains,
                                            print_masked_chains,
...
if __name__ == "__main__":
    ...
    argparser.add_argument(
        "--save_score", type=int, default=0, help="0 for False, 1 for True; save score=-log_prob to npy files"
    )
    argparser.add_argument(
        "--save_probs",
        type=int,
    ...
    argparser.add_argument(
        "--score_only", type=int, default=0, help="0 for False, 1 for True; score input backbone-sequence pairs"
    )
    ...
    argparser.add_argument(
        "--num_seq_per_target", type=int, default=1, help="Number of sequences to generate per target"
    )
    argparser.add_argument(
        "--batch_size",
        type=int,
    ...
    argparser.add_argument(
        "--pdb_path_chains", type=str, default="", help="Define which chains need to be designed for a single PDB "
    )
    ...
    argparser.add_argument(
        "--fixed_positions_jsonl", type=str, default="", help="Path to a dictionary with fixed positions"
    )
    argparser.add_argument(
        "--omit_AAs",
        type=list,
    ...
    argparser.add_argument(
        "--pssm_threshold", type=float, default=0.0, help="A value between -inf + inf to restric per position AAs"
    )
